...
export default function Footer() {
    ...
    return (
        <div className="footer grid  grid-cols-1 lg:grid-cols-3">
            <div className="sitemap col-span-2 py-10 lg:pl-20 text-center lg:text-left text-fsm">
                <div className="heading text-2xl font-bold mb-2">
                    {t('title.sitemap')}
                </div>
                <ul className="flex flex-row justify-center lg:justify-start">
            ...
            <div className="copyright-social p-10">
                <div className="flex flex-row justify-center lg:justify-end mb-4 ">
                ...
                <div className="social-logo flex justify-center lg:justify-end">
